...
function Footer ({pageSize, setPageSize, rowsPerPageOptions}) {
    ...
    const menuItems = rowsPerPageOptions.map(i=>(
        ...
        >
            <Typography variant="body2" component='div' style={{color: `rgba(82, 57, 112, 1)`, fontSize:12, padding:0}}>
                {i}
            </Typography>
        </MenuItem>
    ));
                         ...
                         <Grid container>
                             <Grid item sx={{display:'flex', alignItems: 'center', pr:'26px'}}>
                                 <Typography variant="body2" component='div'
                                             style={{color: `rgba(82, 57, 112, 1)`, fontSize:13, paddingRight:8, fontFamily:"'Nunito'", width: 'max-content'}}
                                 >
                             ...
                             <Grid item sx={{display:'flex', ml:'-26px'}}>
                                 <IconButton size="small" color="primary"
                                             ...
                                             style={{ backgroundColor:`#B372FF`, height:'26px', width:'26px'}}
                                 >
