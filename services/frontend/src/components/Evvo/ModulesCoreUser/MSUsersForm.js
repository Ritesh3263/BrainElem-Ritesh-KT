...
import {Box, CardHeader, Divider, FormControlLabel, IconButton, ListSubheader, OutlinedInput, FilledInput} from '@mui/material';
...
export default function MSUserForm(){
    ...
    function removeUser(){
        moduleCoreService.removeModuleUser(userId).then(res=>{
                ...
                F_showToastMessage(t("User was removed","success"))
                navigate("/sentinel/myusers/users")
            }
                            ...
                            <Form as={Row}>
                                ...
                                <Col md={6} className="d-flex flex-column mt-2">
                                    <FormControl style={{width:"50%"}} >
                                        <StyledButton eSize="small" eVariant="primary" onClick={()=>setOpenSidebarDrawer(true)}>{t("Assign children")}
