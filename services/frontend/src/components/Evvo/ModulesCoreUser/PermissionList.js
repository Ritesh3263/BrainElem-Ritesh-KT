    ...
    <Grid container direction="row">
        ...
        <Grid item xs={12} className='mt-1'>
          <Paper elevation={4} className='px-2'>
            <List dense sx={{
              '&& .alternatingColor': { bgcolor: new_theme.palette.newSupplementary.NSupLightGrey },
              '& .MuiListItem-container': {
                border: `2px solid ${new_theme.palette.newSupplementary.NSupText}`,
                borderRadius: '4px',
                transition: 'border-color 0.4s',
              },
              '& .MuiListItem-container:hover': { border: `2px solid ${new_theme.palette.newSecondary.NSIconDisabled}` },
            }}>
              {permissionList}
