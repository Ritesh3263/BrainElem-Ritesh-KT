...
const GamificationContests = () => {
    const { t } = useTranslation();
    return (
        <ThemeProvider theme={new_theme}>
            <Box>
                <Container maxWidth="xl">
                    <Grid container style={{ height: '450px', backgroundColor: "white", borderRadius: "16px" }} sx={{ padding: { xs: '15px', md: '20px 0 20px 20px', lg: '30px 0px 30px 30px', xl: '40px 0 40px 40px' } }}>
...
export default GamificationContests;