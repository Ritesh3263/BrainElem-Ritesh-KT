        ...
        <ThemeProvider theme={new_theme}>
            <Container maxWidth="xl" className="mainContainerDiv">
                ...
                <Grid container spacing={3}>
                    ...
                    <Grid item xs={12} md={3} className="inner-inputField">
                        <FormControl variant="filled" fullWidth={true}>
                            <InputLabel id="demo-simple-select-label">{t("Parameters")}</InputLabel>
                            <Select
                                labelId="demo-simple-select-label"
                                className="select-inner"
                                value={age}
                ...
                <Grid container spacing={5} sx={{ mt: 1 }}>
                    <Grid item xs={12} md={6}>
                        <img src="/img/congnitive-space/cong_img5.png" className="congnitive-img" />
                    </Grid>
                    <Grid item xs={12} md={6} >
