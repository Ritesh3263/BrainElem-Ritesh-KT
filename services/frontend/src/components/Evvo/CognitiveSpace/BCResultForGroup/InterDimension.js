...
import {
    ...
    CardHeader,
    Divider,
    IconButton, ListSubheader, tabClasses,
} from "@mui/material";
            ...
            <Container maxWidth="xl" className="mainContainerDiv">
                    ...
                    <Grid item xs={12} md={3} className="inner-inputField">
                        <FormControl variant="filled" fullWidth={true}>
                            ...
                            >
                                <MenuItem>{t("Team 1")}</MenuItem>
                                <MenuItem>{t("Team 2")}</MenuItem>
                                {/* <MenuItem>{tabClasses("Team 3")}</MenuItem> */}
                            </Select>
                        </FormControl>
                    </Grid>
                ...
                <Grid container spacing={5} sx={{ mt: 1 }}>
                    <Grid item xs={12} md={6}>
                        <img src="/img/congnitive-space/cong_img3.png" className="congnitive-img" />
                    </Grid>
                    <Grid item xs={12} md={6} >
