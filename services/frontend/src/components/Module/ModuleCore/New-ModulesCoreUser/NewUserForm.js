            ...
            <CardContent classes={{ root: classes.CardContentRoot }} >
                ...
                <Grid container>
                    <Grid item xs={12} className='mt-1'>
                        ...
                        <>
                            <Grid container className="mt-3 account-grid">
                                ...
                                <Grid item xs={12}>
                                    <Typography className="main-heading" variant="h1" component="h1">Create New User</Typography>
                                    <Divider variant="insert" className='heading-divider' />
                                </Grid>
                                <Grid item xs={12} className="role-sec">
                                    <Grid item xs={12} className='mt-3'>
                                        <Typography className="acc_heading" variant="h5" component="h5">Select Roles</Typography>
                                    </Grid>
                                    <Grid item xs={12} className="d-flex flex-column">
                                        <Divider variant="insert" className='my-2 mb-4' />
                                    </Grid>
                                    <FormGroup className="role-checkbox">
                                        <FormControlLabel control={<Checkbox defaultChecked />} label="Architect" />
                                        <FormControlLabel control={<Checkbox />} label="Assistant" />
                                        <FormControlLabel control={<Checkbox />} label="Class Manager" />
                                        <FormControlLabel control={<Checkbox />} label="Coordinator" />
                                        <FormControlLabel control={<Checkbox />} label="Inspector" />
                                        <FormControlLabel control={<Checkbox />} label="Librarian" />

                                        <FormControlLabel control={<Checkbox />} label="Module Manager" />
                                        <FormControlLabel control={<Checkbox />} label="Parent" />
                                        <FormControlLabel control={<Checkbox />} label="Partner" />
                                        <FormControlLabel control={<Checkbox />} label="Trainee" />
                                        <FormControlLabel control={<Checkbox />} label="Trainer" />
                                        <FormControlLabel control={<Checkbox />} label="Training Manager" />
                                    </FormGroup>
                                </Grid>

                                <Grid item xs={12} sm={6} md={3} className="d-flex flex-column px-1">
                                    ...
                                    >
                                        ...
                                        >
                                            <MenuItem key={"demo"} value={""}>user-1</MenuItem>
                                            {/* {companiesList} */}
                                        </Select>
                                    </FormControl>
                                </Grid>
                                <Grid item xs={12} className='mt-3'>
                                    <Typography className="acc_heading" variant="h5" component="h5">{t("Account information")}</Typography>
                                </Grid>
                                <Grid item xs={12} className="d-flex flex-column">
                                    <Divider variant="insert" className='my-2 mb-4' />
                                </Grid>
                                ...
                                {editFormHelper.openType === 'ADD' && (
                                    <Grid item xs={12} sm={6} md={3} className="d-flex flex-column px-1">
                                        <TextField label={t("Confirm password")} margin="dense"
                                            type={visiblePassword ? 'text' : 'password'}
                                            fullWidth={true}
                                            required={true}
                                ...
                                {user.id !== editFormHelper.userId && editFormHelper.openType === 'EDIT' && (
                                    <Grid item xs={12} sm={6} md={3} className="d-flex flex-column px-1">
                                        <TextField label={t("Set password")} margin="dense"
                                            type={visiblePassword ? 'text' : 'password'}
                                            fullWidth={true}
                                            autoComplete="new-password"
                                ...
                                {/* {(currentUser.settings.role === "Partner"|| currentUser.settings.availableRoles.includes("Partner")) &&(
                                            <Grid item xs={6} className="d-flex flex-column px-1">
                                    ...
                                    <>
                                        ...
                                        <Grid item xs={6} className="d-flex flex-column pl-1 pt-3 align-items-end">
                                            {editFormHelper.openType !== 'PREVIEW' && (
                                                <StyledButton  onClick={() => setAssignChildrenDrawer(true)} eVariant="primary" eSize="small">{t("Assign children")}
                                ...
                                <Grid item xs={12} className='mt-3'>
                                    <Typography className="acc_heading" variant="h5" component="h5">Contact Details</Typography>
                                </Grid>
                                <Grid item xs={12} className="d-flex flex-column">
                                    <Divider variant="insert" className='my-2 mb-4' />
                                </Grid>
                            ...
                            <Grid container className="gap-20">
                                <Grid item className="text-right">
                                    <StyledButton eVariant="secondary" eSize="large" onClick={back}>
                                    Back
                                    </StyledButton>
                                </Grid>
                                <Grid item >
                                    {
                                        ...
                                        <StyledButton eVariant="primary" eSize="large" disabled={!editFormHelper.isBlocking || validators.otherPassword} onClick={save}>
                                          {t("Save")}
                                        </StyledButton>
                                    }
                                ...
                                editFormHelper.openType === 'EDIT' && !['ModuleManager', 'Assistant'].includes(currentUser?.settings?.role) && (
                                    <StyledButton eVariant="primary" eSize="large"  onClick={() => setActionModal({ isOpen: true, returnedValue: false })}>
                                    {t("Remove user")}
