...
const Admin = (props) => {
  ...
  var navItems = ['Ecosystems', 'Eco-managers', 'Scripts', 'Blockchain', 'Database'];
  ...
  navItems['Ecosystems'] = {
    ...
    'submenu': false,
    'to': "/ecosystems",
    'visible': user.permissions.find(o => (o.moduleName == 'Ecosystems'))?.access
  }
  navItems['Eco-managers'] = {
    'name': 'Eco-managers',
    'submenu': false,
    'to': "/ecosystems/managers",
    'visible': user.permissions.find(o => (o.moduleName == 'Eco-managers'))?.access,
  };
  navItems['Scripts'] = {
    'name': 'Scripts',
    'submenu': false,
    'to': "/scripts",
    'visible': user.permissions.find(o => o.moduleName == 'Scripts')?.access,
  };
  navItems['Blockchain'] = {
    'name': 'Blockchain',
    'submenu': false,
    'to': "/blockchain/interface",
    'visible': user.permissions.find(o => o.moduleName == 'Blockchain')?.access,
  };
  navItems['Database'] = {
    'name': 'Database',
    'submenu': false,
    'to': "/database/diagram",
    'visible': user.permissions.find(o => o.moduleName == 'Database')?.access,
  };
