...
export default function CertifyEventModal({isOpenCertifyEventModal, setIsOpenCertifyEventModal, currentSession, sessionReducerActionsType, sessionDispatch}){
    ...
    return(
        <Dialog
            open={isOpenCertifyEventModal.isOpen}
            onClose={() => {setIsOpenCertifyEventModal({isOpen: false, openType:'PREVIEW'})}}
            maxWidth={"sm"}
            fullWidth={true}
            aria-labelledby="alert-dialog-title"
            aria-describedby="alert-dialog-description"
        >
            <DialogTitle id="alert-dialog-title" className="text-center" style={{backgroundColor:'rgba(255,255,255,0.8)'}}>
                <Typography variant="h5" component="h2" className="text-center text-justify" style={{color: `rgba(82, 57, 112, 1)`}}>
                    {t("Create certify event")}
                </Typography>
            </DialogTitle>
            <DialogContent className="p-0 my-3">
                <Grid container>
