...
import MyGradesDashboard from "../../../Dashboard/DashboardWidgets/MyGradesDashboard";
...
import BookmarkCourses from "../../../Dashboard/DashboardWidgets/BookmarkCourses";
...
export default function TraineeDashboard(){
    ...
    const upcomingEventsList = upcomingEvents?.length>0 ? upcomingEvents.map(upe=>(
        <Paper elevation={12} className='mb-4 mt-1' >
